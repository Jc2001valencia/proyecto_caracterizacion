            ...
            <div class="bg-white rounded-2xl shadow-lg p-8 mb-6 transition-colors duration-300" id="header-card">
                ...
                <div class="flex flex-col lg:flex-row items-center justify-center gap-4 mb-6">
                    <div class="bg-blue-100 text-blue-800 px-4 py-2 rounded-full font-semibold">
                        ...
                        <?php echo $t['proyecto']; ?>: <?php echo htmlspecialchars($reporte['proyecto']['nombre']); ?>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-blue-100 text-sm mt-1">
                            <?php echo htmlspecialchars($reporte['triple_restriccion']['descripcion']); ?></p>
                    </div>
            ...
            <div class="bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl p-6 shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold"><?php echo htmlspecialchars($reporte['complejidad']['total']); ?>
                            <?php echo $t['factores']; ?></p>
                        <p class="text-green-100 text-sm mt-1">
                            <?php echo $t['nivel_complejidad'] ?? 'Nivel de complejidad identificado'; ?></p>
                    </div>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
                        ...
                        <div class="space-y-4">
                            <div class="bg-gray-50 rounded-lg p-4">
                                ...
                                <p class="text-gray-900 font-semibold">
                                    <?php echo htmlspecialchars($reporte['proyecto']['nombre']); ?></p>
                            </div>
                            <div class="bg-gray-50 rounded-lg p-4">
                                <label
                                    class="block text-sm font-medium text-gray-700 mb-1"><?php echo $t['tamano_estimado']; ?></label>
                                <p class="text-gray-900"><?php echo htmlspecialchars($reporte['proyecto']['tamano']); ?>
                                    <?php echo $t['horas']; ?></p>
                            </div>
                            <div class="bg-gray-50 rounded-lg p-4">
                                <label
                                    class="block text-sm font-medium text-gray-700 mb-1"><?php echo $t['pais_cliente']; ?></label>
                                <p class="text-gray-900"><?php echo htmlspecialchars($reporte['proyecto']['pais']); ?>
                                </p>
                            </div>
                        </div>
                        <div class="space-y-4">
                            <div class="bg-gray-50 rounded-lg p-4">
                                ...
                                <p class="text-gray-900">
                                    <?php echo htmlspecialchars($reporte['proyecto']['dominio_problema']); ?></p>
                            </div>
                            <div class="bg-gray-50 rounded-lg p-4 md:col-span-2">
                                <label
                                    class="block text-sm font-medium text-gray-700 mb-1"><?php echo $t['descripcion']; ?></label>
                                <p class="text-gray-900">
                                    <?php echo htmlspecialchars($reporte['proyecto']['descripcion']); ?></p>
                            </div>
                        </div>
                    </div>
                ...
                <section class="bg-white rounded-2xl shadow-lg p-6 fade-in print-break transition-colors duration-300"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-4 flex items-start">
                            ...
                            <div>
                                <p class="text-yellow-800 font-medium"><?php echo htmlspecialchars($factor); ?></p>
                                <p class="text-yellow-600 text-sm mt-1"><?php echo $t['factor_complejidad']; ?></p>
                            </div>
                        </div>
                        <?php endforeach; ?>
                    </div>
                    ...
                    <div class="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                        <div class="flex items-center">
                            ...
                            <div>
                                <p class="text-blue-800 font-medium"><?php echo $t['recomendacion']; ?></p>
            ...
            <div class="space-y-8">
                        ...
                        <div
                            ...
                            <div class="flex justify-between items-start mb-2">
                                <h4 class="font-semibold text-gray-900 text-lg">
                                    <?php echo htmlspecialchars($categoria); ?></h4>
                                <span
                                    class="bg-purple-100 text-purple-800 text-xs px-2 py-1 rounded-full"><?php echo $t['recomendado']; ?></span>
                            </div>
                            <p class="text-gray-700 leading-relaxed"><?php echo htmlspecialchars($valor); ?></p>
                ...
                <section class="bg-white rounded-2xl shadow-lg p-6 no-print transition-colors duration-300"
                    id="quick-actions">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4"><?php echo $t['acciones_rapidas']; ?></h3>
