...
@media print {
    ...
    <body class="bg-gray-50 text-gray-800"><div class="max-w-6xl mx-auto px-6 py-10">.print-break {
        page-break-before: always;
    }

    < !-- Encabezado --><div class="text-center mb-10"><h1 class="text-3xl font-semibold text-blue-700">Caracterización del proyecto </h1><p class="text-gray-500 mt-2">Resultados del análisis según el modelo Cynefin</p></div>body {
        font-size: 12pt;
        background: white !important;
    }

    < !-- Información del Proyecto --><section class="bg-white shadow rounded-lg p-6 mb-8"><h2 class="text-xl font-semibold text-gray-700 mb-4">1. Información del proyecto</h2>.bg-gray-50 {
        background: white !important;
    }

    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6"><div><span class="font-medium">Nombre del proyecto:</span><p class="text-gray-600"><?php echo htmlspecialchars($reporte['proyecto']['nombre']);
    ?></p></div><div><span class="font-medium">Tamaño estimado:</span><p class="text-gray-600"><?php echo htmlspecialchars($reporte['proyecto']['tamano']);
    ?></p></div><div><span class="font-medium">País del cliente:</span><p class="text-gray-600"><?php echo htmlspecialchars($reporte['proyecto']['pais']);
    ?></p></div><div><span class="font-medium">Dominio del problema:</span><p class="text-gray-600"><?php echo htmlspecialchars($reporte['proyecto']['dominio_problema']);
    ?></p></div><div class="md:col-span-2"><span class="font-medium">Breve descripción:</span><p class="text-gray-600"><?php echo htmlspecialchars($reporte['proyecto']['descripcion']);
...
<body class="bg-gray-50 text-gray-800 min-h-screen transition-colors duration-300" id="body">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center">
                    ...
                    <h1 class="text-lg font-semibold text-gray-900" id="nav-title">
                        <?php echo $t['sistema_caracterizacion']; ?></h1>
                </div>
            </div>
                ...
                <div class="mt-4">
                    ...
                    <div class="overflow-x-auto">
                        ...
                        <a href="../index.php"
                            ...
                            <span class="hidden sm:inline"><?php echo $t['nuevo']; ?></span>
                        </a>
                    </div>
                    <?php else: ?>
        ...
        <div class="bg-blue-50 p-5 rounded-lg border border-blue-100">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="text-center mb-12 fade-in">
                    <div class="bg-white rounded-2xl shadow-lg p-8 mb-6 transition-colors duration-300"
                        id="header-card">
                        <h1 class="text-3xl lg:text-4xl font-bold text-gray-900 mb-4" id="main-title">
                            <?php echo $t['titulo']; ?>
                        </h1>
                        ...
                        <p class="text-gray-600 text-lg max-w-3xl mx-auto" id="subtitle">
                ...
                <div class="bg-green-50 p-5 rounded-lg border border-green-100">
                    ...
                    <section class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8 fade-in">
                        ...
                        <div class="bg-purple-50 p-5 rounded-lg border border-purple-100">
                            ...
                            <div
                                class="bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl p-6 shadow-lg">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <h3 class="text-lg font-semibold mb-2"><?php echo $t['complejidad']; ?></h3>
                                        <p class="text-2xl font-bold">
                                            <?php echo htmlspecialchars($reporte['complejidad']['total']); ?>
                                            <?php echo $t['factores']; ?></p>
                                        <p class="text-green-100 text-sm mt-1">
                                            <?php echo $t['nivel_complejidad'] ?? 'Nivel de complejidad identificado'; ?>
                                        </p>
                                    </div>
                    ...
                    <section class="bg-white shadow rounded-lg p-6 mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            ...
                            <div class="bg-yellow-50 border border-yellow-200 rounded p-3 text-yellow-800">
                                ...
                                <div
                                    class="bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-xl p-6 shadow-lg">
                                    <div class="flex items-center justify-between">
                                        <div>
                                            <h3 class="text-lg font-semibold mb-2"><?php echo $t['dominio_cynefin']; ?>
                                            </h3>
                                            <p class="text-2xl font-bold">
                                                <?php echo htmlspecialchars($reporte['dominio_cynefin']); ?></p>
                                            <p class="text-purple-100 text-sm mt-1">
                                                <?php echo $t['contexto_proyecto']; ?></p>
                                        </div>
                        ...
                        <div id="modo-visualizacion" class="space-y-4">
                            ...
                            <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
                                ...
                                <div class="xl:col-span-2 space-y-8">
                                    ...
                                    <section
                                        class="bg-white rounded-2xl shadow-lg p-6 fade-in transition-colors duration-300"
                                        id="project-info">
                                                        ...
                                                        <tr class="hover:bg-gray-50 transition">
                                                            ...
                                                            <td class="px-4 py-3 text-right text-sm text-gray-600">
                                                                <div class="flex items-center justify-end">
                                                                    ...
                                                                    <span
                                                                        class="text-xs"><?= round($porcentaje) ?>%</span>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <?php endforeach; ?>
                                                        <tr class="bg-gray-50 font-semibold">
                                                            <td class="px-4 py-3 text-sm"><?php echo $t['total']; ?>
                                                            </td>
                                    ...
                                    <?php if (!empty($reporte['complejidad']['factores'])): ?>
                                    <section
                                        class="bg-white rounded-2xl shadow-lg p-6 fade-in print-break transition-colors duration-300"
                                            ...
                                            <div
                                                ...
                                                <div>
                                                    <p class="text-yellow-800 font-medium">
                                                        <?php echo htmlspecialchars($factor); ?></p>
                                                    <p class="text-yellow-600 text-sm mt-1">
                                                        <?php echo $t['factor_complejidad']; ?></p>
                                                </div>
                                            </div>
                                            <?php endforeach; ?>
                                        </div>
                                            ...
                                            <div class="space-y-8">
                                                ...
                                                <section
                                                    ...
                                                    <div
                                                        ...
                                                        <h2
                                                            class="text-2xl font-bold text-gray-900 flex items-center mb-4 sm:mb-0">
                                                        ...
                                                        <div class="flex space-x-2 no-print">
                                                            <button onclick="toggleEdicion()" id="btn-editar"
                                                                ...
                                                                <span
                                                                    id="btn-editar-text"><?php echo $t['editar']; ?></span>
                                                            </button>
                                                        </div>
                                                    </div>
                                                    <?php endforeach; ?>
                                                            ...
                                                            <div id="modo-visualizacion" class="space-y-4">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="flex justify-between items-start mb-2">
                                                                        ...
                                                                        <span
                                                                            class="bg-purple-100 text-purple-800 text-xs px-2 py-1 rounded-full"><?php echo $t['recomendado']; ?></span>
                                                                    </div>
                                                                    <p class="text-gray-700 leading-relaxed">
                                                                        <?php echo htmlspecialchars($valor); ?></p>
                                                                    <div class="mt-3 flex items-center justify-between">
                                                                        <div class="rating-stars text-sm">
                                                                            <span
                                                                                class="text-gray-500 mr-2"><?php echo $t['fue_util']; ?></span>
                                                                            <?php for ($i = 1; $i <= 5; $i++): ?>
                                                                        ...
                                                                        <button
                                                                            onclick="mostrarComentario('<?php echo htmlspecialchars($categoria); ?>')"
                                                            ...
                                                            <div id="modo-edicion" class="hidden space-y-4">
                                                                <form id="form-estrategias" class="space-y-4">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <label
                                                                            class="block font-semibold text-gray-900 mb-2 text-lg">
                                                                            <?php echo htmlspecialchars($categoria); ?>
                                                                        </label>
                                                                        <textarea
                                                                            name="<?php echo htmlspecialchars($categoria); ?>"
                                                ...
                                                <!-- Acciones Rápidas -->
                                                <section
                                                    class="bg-white rounded-2xl shadow-lg p-6 no-print transition-colors duration-300"
                                                    id="quick-actions">
                                                    <h3 class="text-lg font-semibold text-gray-900 mb-4">
                                                        <?php echo $t['acciones_rapidas']; ?></h3>
    ...
    <div class="flex justify-between">
        <button onclick="window.history.back()" class="px-6 py-2 bg-gray-500 text-white rounded-md hover:bg-gray-600">
            Volver
        </button>
            ...
            <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md transition-colors duration-300"
                ...
                <div class="p-6 border-b">
                    <h3 class="text-lg font-semibold text-gray-900" id="modal-titulo">
                        <?php echo $t['agregar_comentario']; ?></h3>
                </div>
                <div class="p-6">
        ...
        function toggleEdicion() {
            ...
            const botonTexto = document.getElementById('btn-editar-text');
        ...
        function cancelarEdicion() {
            ...
            document.getElementById('btn-editar').innerHTML =
                '<i class="fas fa-edit mr-2"></i><span id="btn-editar-text">' + textos[idiomaActual]['editar'] +
                '</span>';
        ...
        function exportarWord() {
            // Simulación de exportación Word
            ...
            fetch('guardar_estrategias.php', {
                        ...
                        .then(data => {
                            msg.innerHTML = data.success ?
                                ...
                                '<div class="bg-red-100 text-red-700 p-3 rounded">Error: ' + data.message +
                                '</div>';
                    ...
                    `;
                        ...
                        .catch(() => {
                                msg.innerHTML =
                                    '<div class="bg-red-100 text-red-700 p-3 rounded">Error al guardar</div>';
                                .catch(error => {
                                    msg.innerHTML = `
                    <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded-lg">
                        <i class="fas fa-exclamation-triangle mr-2"></i>
                ...
                `;
                                ...
                                if (navigator.share) {
                                    navigator.share({
                                        title: textos[idiomaActual]['titulo'] + ' - ' +
                                            <?php echo json_encode($reporte['proyecto']['nombre']); ?>,
                            ...
                            function toggleDarkMode() {
                                ...
                                if (darkMode) {
                                    ...
                                    toggleBtn.innerHTML =
                                        '<i class="fas fa-sun mr-2"></i><span class="hidden sm:inline">' + textos[
                                            idiomaActual]['modo_claro'] + '</span>';
                                } else {
                                    body.classList.remove('dark-mode');
                                    toggleBtn.innerHTML =
                                        '<i class="fas fa-moon mr-2"></i><span class="hidden sm:inline">' + textos[
